...
@Component({
  selector: 'app-saved-trailcard',
  templateUrl: './saved-trailcard.component.html',
  styleUrls: ['./saved-trailcard.component.scss'],
})
export class SavedTrailcardComponent implements OnInit {
